<template>
	<div id="meetboard-mount">
		<div
			jsshadow=""
			role="button"
			class="uArJ5e UQuaGc kCyAyd QU4Gid foXzLb IeuGXd"
			jscontroller="VXdfxd"
...
export default {
	...
	methods: {
		show() {
			let defaulter = document.querySelector(".lvE3se");
